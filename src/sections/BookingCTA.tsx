  ...
  return (
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <span className="text-gold text-xs font-semibold tracking-[0.6em] uppercase mb-8 block">
            Ready for a change?
          </span>
          ...
          <p className="text-warm-gray/60 text-lg mb-12 font-light max-w-xl mx-auto leading-relaxed">
            Step into our world of luxury. Limited slots available for premium
            balayage and bridal consultations.
          </p>
          <Link to="/book">
